...
- `cloud_id`: [String] Will be converted to YAML for the optional cloud.id of the configuration (see documentation, and above)
- `cloud_auth`: [String] Will be converted to YAML for the optional cloud.auth of the configuration (see documentation, and above) 
